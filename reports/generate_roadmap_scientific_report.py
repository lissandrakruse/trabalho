...
def build_report() -> None:
    ...
    roadmap = styled_table(
        [
            ...
            ["Intervalos", "O valor empirico completo recebe margem de 0,001, sem arredondamento.", "probability_interval()"],
    ...
    algorithms = styled_table(
        [
            ...
            ["Intervalo", "p-0,001 <= P(E) <= p+0,001, limitado a [0,1]", "Representa tolerancia sem arredondar a evidencia."],
